...
| [Configure.Ssg.cs](https://github.com/NetCoreTemplates/razor-press/blob/main/RazorPress/Configure.Ssg.cs) | Initializes and registers the feature with ASP .NET's IOC             |
...
- [/Vue/Page.cshtml](https://github.com/NetCoreTemplates/razor-press/tree/main/RazorPress/Pages/Vue/Page.cshtml)
- [/CreatorKit/Page.cshtml](https://github.com/NetCoreTemplates/razor-press/tree/main/RazorPress/Pages/CreatorKit/Page.cshtml)

They can contain custom Razor Pages as needed, e.g. both [/vue/](/and/) and [/creatorkit/](/creatorkit/) have custom index pages:

- [/Vue/Index.cshtml](https://github.com/NetCoreTemplates/razor-press/tree/main/RazorPress/Pages/Vue/Index.cshtml)
- [/CreatorKit/Index.cshtml](https://github.com/NetCoreTemplates/razor-press/tree/main/RazorPress/Pages/CreatorKit/Index.cshtml)
...
- [/AutoQuery.cshtml](https://github.com/ServiceStack/docs.servicestack.net/blob/main/RazorPress/Pages/AutoQuery.cshtml)
- [/OrmLite.cshtml](https://github.com/ServiceStack/docs.servicestack.net/blob/main/RazorPress/Pages/OrmLite.cshtml)
- [/Redis.cshtml](https://github.com/ServiceStack/docs.servicestack.net/blob/main/RazorPress/Pages/Redis.cshtml)
...
The code that loads the Pages feature markdown content is in [Markdown.Pages.cs](https://github.com/NetCoreTemplates/razor-press/blob/main/RazorPress/Markdown.Pages.cs),
...
- [Markdown.WhatsNew.cs](https://github.com/NetCoreTemplates/razor-press/blob/main/RazorPress/Markdown.WhatsNew.cs)

and rendered in:
- [WhatsNew.cshtml](https://github.com/NetCoreTemplates/razor-press/blob/main/RazorPress/Pages/WhatsNew.cshtml)
...
pages in [/_videos](https://github.com/NetCoreTemplates/razor-press/tree/main/RazorPress/_videos):
...
- [Markdown.Videos.cs](https://github.com/NetCoreTemplates/razor-press/blob/main/RazorPress/Markdown.Videos.cs)

and Rendered with Razor Pages:

- [Shared/VideoGroup.cshtml](https://github.com/NetCoreTemplates/razor-press/blob/main/RazorPress/Pages/Shared/VideoGroup.cshtml) - Razor Partial for displaying a Video Collection
- [Videos.cshtml](https://github.com/NetCoreTemplates/razor-press/blob/main/RazorPress/Pages/Videos.cshtml) - Razor Page displaying multiple Video Collections
...
This capability is provided by the new [Markdown.Meta.cs](https://github.com/NetCoreTemplates/razor-ssg/blob/main/RazorPress/Markdown.Meta.cs) 
...
All markdown features are initialized in the same way in [Configure.Ssg.cs](https://github.com/NetCoreTemplates/razor-press/blob/main/RazorPress/Configure.Ssg.cs)
...
[postinstall.js](https://github.com/NetCoreTemplates/razor-press/blob/main/RazorPress/postinstall.js) by running:
...
The included [MarkdownTagHelper.cs](https://github.com/NetCoreTemplates/razor-press/blob/main/RazorPress/MarkdownTagHelper.cs) can be used
in hybrid Razor Pages like [About.cshtml](https://github.com/NetCoreTemplates/razor-ssg/blob/main/RazorPress/Pages/About.cshtml)
