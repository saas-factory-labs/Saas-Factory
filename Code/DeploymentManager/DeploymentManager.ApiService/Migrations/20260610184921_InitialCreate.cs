    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false, comment: "Unique identifier for the authentication provider")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, comment: "Name of the authentication provider (e.g., Google, Microsoft, Auth0, GitHub)"),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true, comment: "Indicates if this authentication provider is currently active and available for use"),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP", comment: "Timestamp when the authentication provider was created"),
                    LastUpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Timestamp when the authentication provider was last updated")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedBy = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    Active = table.Column<bool>(type: "boolean", nullable: false),
                    Deleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedBy = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    DeletedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    AppType = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_dm_apps", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedBy = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    DeletedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CustomerType = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_dm_customers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedBy = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    DeletedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DeploymentType = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_dm_deployments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    Abbreviation = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    Description = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    Created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Updated = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    ...
                    DeletedBy = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    DeletedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ProjectType = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_dm_projects", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    Url = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: false, comment: "Customer-registered outbound endpoint URL"),
                    Secret = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false, comment: "HMAC-SHA256 signing secret for outbound payloads"),
                    Description = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
                    EventTypes = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false, defaultValue: "", comment: "Comma-separated event type filter; empty means all events"),
                    TenantId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, comment: "Tenant this webhook endpoint belongs to"),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastUpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsSoftDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false, comment: "Unique tenant identifier with prefix (e.g., tenant_01ABCD...)"),
                    TenantType = table.Column<int>(type: "integer", nullable: false, comment: "0 = Personal (B2C), 1 = Organization (B2B)"),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, comment: "Tenant name: Full name for Personal, Company name for Organization"),
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true, comment: "Optional description, typically used for Organization tenants"),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, comment: "Whether tenant can access the system"),
                    IsPrimary = table.Column<bool>(type: "boolean", nullable: false, comment: "Indicates primary tenant for multi-tenant B2C users"),
                    Email = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true, comment: "Contact email for the tenant"),
                    Phone = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true, comment: "Contact phone for the tenant"),
                    VatNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true, comment: "VAT/Tax number (B2B only)"),
                    Country = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true, comment: "Country code (B2B only)"),
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: "Timestamp when tenant was created"),
                    LastUpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, comment: "Timestamp when tenant was last modified"),
                    IsSoftDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false, comment: "Soft delete flag")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Metadata = table.Column<EntityMetadata>(type: "jsonb", nullable: true, comment: "Generic metadata including PII detection results"),
                    ExternalAuthId = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false, comment: "Unique identifier for the external identity link")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false, comment: "Internal user ID"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserExternalIdentities_AuthenticationProviders_Authenticati~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastUpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsSoftDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthenticationProviders_CreatedAt",
                table: "AuthenticationProviders",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AuthenticationProviders_IsActive",
                table: "AuthenticationProviders",
                column: "IsActive");
