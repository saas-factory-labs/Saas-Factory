...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.Address.AddressEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(1024)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.City.CityEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.Country.CountryEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.CountryRegion.CountryRegionEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.State.StateEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(1024)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.Street.StreetEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(1024)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Auditing.ApiLog.ApiLogEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Auditing.AuditLog.AuditLogEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authentication.AuthenticationProvider.AuthenticationProviderEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authentication.UserExternalIdentity.UserExternalIdentityEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authorization.Permission.PermissionEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authorization.ResourcePermission.ResourcePermissionEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authorization.Role.RoleEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authorization.RolePermission.RolePermissionEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authorization.UserRole.UserRoleEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Customer.Account.AccountEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(1024)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Email.EmailVerification.EmailVerificationEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.FileEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(1024)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.FileManagement.FileMetadataEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(1024)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.User.Profile.ProfileEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(1024)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.Address.AddressEntity", b =>
                {
                    b.HasOne("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.City.CityEntity", "City")
                        .WithMany()
                    ...
                    b.HasOne("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.Country.CountryEntity", "Country")
                        .WithMany()
                    ...
                    b.HasOne("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.Street.StreetEntity", "Street")
                        .WithMany()
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.City.CityEntity", b =>
                {
                    b.HasOne("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.Country.CountryEntity", null)
                        .WithMany("Cities")
                    ...
                    b.HasOne("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Addressing.State.StateEntity", "State")
                        .WithMany()
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authentication.UserExternalIdentity.UserExternalIdentityEntity", b =>
                {
                    b.HasOne("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authentication.AuthenticationProvider.AuthenticationProviderEntity", "AuthenticationProvider")
                        .WithMany()
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authorization.ResourcePermissionType.ResourcePermissionTypeEntity", b =>
                {
                    b.HasOne("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authorization.ResourcePermission.ResourcePermissionEntity", "ResourcePermission")
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authorization.RolePermission.RolePermissionEntity", b =>
                {
                    b.HasOne("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authorization.Permission.PermissionEntity", "Permission")
                        .WithMany()
                    ...
                    b.HasOne("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.Authorization.Role.RoleEntity", "Role")
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.User.Profile.ProfileEntity", b =>
                {
                    b.HasOne("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.User.UserEntity", "User")
                        .WithOne("Profile")
                        .HasForeignKey("AppBlueprint.Infrastructure.DatabaseContexts.Baseline.Entities.User.Profile.ProfileEntity", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
