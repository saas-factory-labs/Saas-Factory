...
<Project>
    <PropertyGroup>
        ...
        <RepositoryUrl>https://github.com/saas-factory-labs/Saas-Factory/SaaS-Factory</RepositoryUrl>
...
<configuration>
    <packageSources>
        ...
        <add key="saas-factory-labsSaas-Factory-github" value="https://nuget.pkg.github.com/saas-factory-labs/Saas-Factory/index.json" />
    </packageSources>
    ...
    <packageSourceMapping>
        ...
        <!--     <package pattern="*" /> -->
        <!-- </packageSource> -->
        <packageSource key="saas-factory-labs-Saas-Factory-github">
    ...
    <packageSourceCredentials>
        <saas-factory-labs-github>
            <add key="Username" value="saas-factory-labs-Saas-Factory" />
...
RUN sed -i "s|%GITHUB_PAT%|$GITHUB_PAT|g" /root/.nuget/NuGet.Config
