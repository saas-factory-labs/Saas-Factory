...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.Persistence.DatabaseContexts.B2B.Entities.ApiKeyEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(1024)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.Persistence.DatabaseContexts.B2B.Entities.Organization.OrganizationEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.Persistence.DatabaseContexts.B2B.Entities.Team.Team.TeamEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.Persistence.DatabaseContexts.B2B.Entities.Team.TeamInvite.TeamInviteEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.Persistence.DatabaseContexts.B2B.Entities.Team.TeamMember.TeamMemberEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .IsUnicode(true)
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.Persistence.DatabaseContexts.B2B.Entities.Team.Team.TeamEntity", b =>
                {
                    b.HasOne("AppBlueprint.Infrastructure.Persistence.DatabaseContexts.B2B.Entities.Organization.OrganizationEntity", null)
                        .WithMany("Teams")
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.Persistence.DatabaseContexts.B2B.Entities.Team.TeamInvite.TeamInviteEntity", b =>
                {
                    ...
                    b.HasOne("AppBlueprint.Infrastructure.Persistence.DatabaseContexts.B2B.Entities.Team.Team.TeamEntity", "Team")
