...
namespace AppBlueprint.Infrastructure.Persistence.DatabaseContexts.Baseline.Migrations
{
    ...
    [Migration("20260203071153_AddFullTextSearchVectors")]
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.Persistence.DatabaseContexts.Baseline.Entities.Tenant.TenantEntity", b =>
                {
                    ...
                    b.Property<string>("SearchVector")
                        ...
                        .IsUnicode(true)
                        .HasColumnType("character varying(1024)")
                        .HasComputedColumnSql("to_tsvector('english', coalesce(\"Name\", '') || ' ' || coalesce(\"Description\", '') || ' ' || coalesce(\"Email\", '') || ' ' || coalesce(\"VatNumber\", ''))", true)
                        .HasComment("Full-text search vector for tenant search");
                    ...
                    b.HasIndex("SearchVector")
                        .HasDatabaseName("IX_Tenants_SearchVector");
            ...
            modelBuilder.Entity("AppBlueprint.Infrastructure.Persistence.DatabaseContexts.Baseline.Entities.User.UserEntity", b =>
                {
                    ...
                    b.Property<string>("SearchVector")
                        ...
                        .IsUnicode(true)
                        .HasColumnType("character varying(1024)")
                        .HasComputedColumnSql("to_tsvector('english', coalesce(\"FirstName\", '') || ' ' || coalesce(\"LastName\", '') || ' ' || coalesce(\"UserName\", '') || ' ' || coalesce(\"Email\", ''))", true)
                        .HasComment("Full-text search vector for user search");
