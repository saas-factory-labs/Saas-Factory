...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.TeamEntity>? Teams { get; set; }
#nullable restore
#else
        public List<global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.TeamEntity> Teams { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.UserEntity>? Users { get; set; }
#nullable restore
#else
        public List<global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.UserEntity> Users { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.TenantEntity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.TenantEntity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.TenantEntity();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "teams", n => { Teams = n.GetCollectionOfObjectValues<global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.TeamEntity>(global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.TeamEntity.CreateFromDiscriminatorValue)?.AsList(); } },
                { "type", n => { Type = n.GetStringValue(); } },
                { "users", n => { Users = n.GetCollectionOfObjectValues<global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.UserEntity>(global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.UserEntity.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.TeamEntity>("teams", Teams);
            writer.WriteStringValue("type", Type);
            writer.WriteCollectionOfObjectValues<global::AppBlueprint.Presentation.Ui.Sdk.Client.Models.UserEntity>("users", Users);
