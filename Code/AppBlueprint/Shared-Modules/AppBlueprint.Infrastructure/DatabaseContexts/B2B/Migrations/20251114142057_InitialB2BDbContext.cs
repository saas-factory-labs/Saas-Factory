        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreatedById = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    AssignedToId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastUpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsSoftDeleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, comment: "The friendly name of the API key"),
                    Description = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true, comment: "Optional description of the API key purpose"),
                    SecretRef = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false, comment: "Reference to the secret stored in Azure Key Vault"),
                    UserId = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false, comment: "Foreign key to the user who owns this API key"),
                    TenantId = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: "Timestamp when the API key was created"),
                    LastUpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsSoftDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Organizations_IsSoftDeleted",
                table: "Organizations",
                column: "IsSoftDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamInvites_IsActive",
                table: "TeamInvites",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_TeamInvites_IsSoftDeleted",
                table: "TeamInvites",
                column: "IsSoftDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamMembers_IsSoftDeleted",
                table: "TeamMembers",
                column: "IsSoftDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Todos_TenantId_AssignedToId_IsCompleted",
                table: "Todos",
                columns: new[] { "TenantId", "AssignedToId", "IsCompleted" });

            migrationBuilder.CreateIndex(
                name: "IX_Todos_TenantId_IsCompleted",
                table: "Todos",
                columns: new[] { "TenantId", "IsCompleted" });

            migrationBuilder.CreateIndex(
                name: "IX_Todos_TenantId_Priority_DueDate",
                table: "Todos",
                columns: new[] { "TenantId", "Priority", "DueDate" });
