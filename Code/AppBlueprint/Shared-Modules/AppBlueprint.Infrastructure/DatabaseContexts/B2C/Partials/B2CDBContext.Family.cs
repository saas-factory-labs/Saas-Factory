using AppBlueprint.Infrastructure.DatabaseContexts.B2C.Entities.EntityConfigurations;
...
using AppBlueprint.Infrastructure.DatabaseContexts.B2C.Family.FamilyInvite;
