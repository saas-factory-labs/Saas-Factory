...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::AppBlueprint.Api.Client.Sdk.Models.TenantEntity>? Tenants { get; set; }
#nullable restore
#else
        public List<global::AppBlueprint.Api.Client.Sdk.Models.TenantEntity> Tenants { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::AppBlueprint.Api.Client.Sdk.Models.CustomerEntity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::AppBlueprint.Api.Client.Sdk.Models.CustomerEntity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::AppBlueprint.Api.Client.Sdk.Models.CustomerEntity();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "tenants", n => { Tenants = n.GetCollectionOfObjectValues<global::AppBlueprint.Api.Client.Sdk.Models.TenantEntity>(global::AppBlueprint.Api.Client.Sdk.Models.TenantEntity.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::AppBlueprint.Api.Client.Sdk.Models.TenantEntity>("tenants", Tenants);
