...
--
-- Name: AdminAuditLog_Id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public."FileMetadata" (
    ...
    "CustomMetadata" jsonb DEFAULT '{}'::jsonb,
...
CREATE TABLE public."NotificationPreferences" (
    ...
    "QuietHoursStart" interval,
    "QuietHoursEnd" interval,
    "CreatedAt" timestamp with time zone NOT NULL,
    "LastUpdatedAt" timestamp with time zone,
    "IsSoftDeleted" boolean NOT NULL
);
...
--
-- Name: PushNotificationTokens; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."PushNotificationTokens" (
    "Id" character varying(40) NOT NULL,
    "TenantId" character varying(40) NOT NULL,
    "UserId" character varying(40) NOT NULL,
...
CREATE TABLE public."WebhookEvents" (
    ...
    "TenantId" character varying(40) DEFAULT ''::character varying NOT NULL,
    "Status" character varying(50) NOT NULL,
...
--
-- Name: COLUMN "WebhookEvents"."Id"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public."WebhookEvents"."Id" IS 'Unique webhook event identifier with prefix (e.g., whevt_01ABCD...)';


--
-- Name: COLUMN "WebhookEvents"."EventId"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public."WebhookEvents"."EventId" IS 'External event ID from webhook provider (e.g., Stripe event ID)';


--
-- Name: COLUMN "WebhookEvents"."EventType"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public."WebhookEvents"."EventType" IS 'Type of webhook event (e.g., payment_intent.succeeded)';


--
-- Name: COLUMN "WebhookEvents"."Source"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public."WebhookEvents"."Source" IS 'Source of webhook (e.g., stripe, paypal)';


--
-- Name: COLUMN "WebhookEvents"."Payload"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public."WebhookEvents"."Payload" IS 'Raw JSON payload of webhook event';


--
-- Name: COLUMN "WebhookEvents"."TenantId"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public."WebhookEvents"."TenantId" IS 'Tenant ID if webhook is tenant-scoped';


--
-- Name: COLUMN "WebhookEvents"."Status"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public."WebhookEvents"."Status" IS 'Processing status (Pending, Processed, Failed, etc.)';


--
-- Name: COLUMN "WebhookEvents"."RetryCount"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public."WebhookEvents"."RetryCount" IS 'Number of retry attempts';


--
-- Name: COLUMN "WebhookEvents"."ErrorMessage"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public."WebhookEvents"."ErrorMessage" IS 'Error message if processing failed';


--
-- Name: COLUMN "WebhookEvents"."ReceivedAt"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public."WebhookEvents"."ReceivedAt" IS 'Timestamp when event was received';


--
-- Name: COLUMN "WebhookEvents"."ProcessedAt"; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public."WebhookEvents"."ProcessedAt" IS 'Timestamp when event was successfully processed';
...
--
-- Name: AdminAuditLog Id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: FileMetadata PK_FileMetadata; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: NotificationPreferences PK_NotificationPreferences; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."NotificationPreferences"
    ADD CONSTRAINT "PK_NotificationPreferences" PRIMARY KEY ("Id");
...
--
-- Name: PushNotificationTokens PK_PushNotificationTokens; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."PushNotificationTokens"
    ADD CONSTRAINT "PK_PushNotificationTokens" PRIMARY KEY ("Id");
...
--
-- Name: FileMetadata UQ_FileMetadata_FileKey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."FileMetadata"
    ADD CONSTRAINT "UQ_FileMetadata_FileKey" UNIQUE ("FileKey");
...
--
-- Name: IX_FileMetadata_CreatedAt; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_FileMetadata_CreatedAt" ON public."FileMetadata" USING btree ("CreatedAt");


--
-- Name: IX_FileMetadata_TenantId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_FileMetadata_TenantId" ON public."FileMetadata" USING btree ("TenantId");


--
-- Name: IX_FileMetadata_TenantId_Folder; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_FileMetadata_TenantId_Folder" ON public."FileMetadata" USING btree ("TenantId", "Folder");


--
-- Name: IX_FileMetadata_TenantId_UploadedBy; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_FileMetadata_TenantId_UploadedBy" ON public."FileMetadata" USING btree ("TenantId", "UploadedBy");
...
--
-- Name: IX_NotificationPreferences_TenantId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_NotificationPreferences_TenantId" ON public."NotificationPreferences" USING btree ("TenantId");


--
-- Name: IX_NotificationPreferences_UserId; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_NotificationPreferences_UserId" ON public."NotificationPreferences" USING btree ("UserId");
...
--
-- Name: IX_PushNotificationTokens_TenantId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_PushNotificationTokens_TenantId" ON public."PushNotificationTokens" USING btree ("TenantId");


--
-- Name: IX_PushNotificationTokens_Token; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_PushNotificationTokens_Token" ON public."PushNotificationTokens" USING btree ("Token");


--
-- Name: IX_PushNotificationTokens_UserId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_PushNotificationTokens_UserId" ON public."PushNotificationTokens" USING btree ("UserId");


--
-- Name: IX_PushNotificationTokens_UserId_IsActive; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_PushNotificationTokens_UserId_IsActive" ON public."PushNotificationTokens" USING btree ("UserId", "IsActive");
...
--
-- Name: IX_UserNotifications_CreatedAt; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_UserNotifications_CreatedAt" ON public."UserNotifications" USING btree ("CreatedAt");


--
-- Name: IX_UserNotifications_TenantId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_UserNotifications_TenantId" ON public."UserNotifications" USING btree ("TenantId");


--
-- Name: IX_UserNotifications_UserId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_UserNotifications_UserId" ON public."UserNotifications" USING btree ("UserId");
...
--
-- Name: IX_WebhookEvents_EventId_Source; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_WebhookEvents_EventId_Source" ON public."WebhookEvents" USING btree ("EventId", "Source");


--
-- Name: IX_WebhookEvents_Id; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_WebhookEvents_Id" ON public."WebhookEvents" USING btree ("Id");


--
-- Name: IX_WebhookEvents_ReceivedAt; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_WebhookEvents_ReceivedAt" ON public."WebhookEvents" USING btree ("ReceivedAt");


--
-- Name: IX_WebhookEvents_Status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_WebhookEvents_Status" ON public."WebhookEvents" USING btree ("Status");


--
-- Name: IX_WebhookEvents_TenantId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_WebhookEvents_TenantId" ON public."WebhookEvents" USING btree ("TenantId");


--
-- Name: idx_admin_audit_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_admin_audit_tenant ON public."AdminAuditLog" USING btree ("TenantId", "Timestamp" DESC);


--
-- Name: idx_admin_audit_timestamp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_admin_audit_timestamp ON public."AdminAuditLog" USING btree ("Timestamp" DESC);


--
-- Name: idx_admin_audit_user; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_admin_audit_user ON public."AdminAuditLog" USING btree ("AdminUserId", "Timestamp" DESC);
...
--
-- Name: ContactPersons; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public."ContactPersons" ENABLE ROW LEVEL SECURITY;

--
-- Name: EmailAddresses; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public."EmailAddresses" ENABLE ROW LEVEL SECURITY;

--
-- Name: PhoneNumbers; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public."PhoneNumbers" ENABLE ROW LEVEL SECURITY;
