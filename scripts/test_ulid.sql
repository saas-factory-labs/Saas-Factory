...
INSERT INTO "Tenants" ("Id", "Name", "Description", "IsActive", "IsPrimary", "Email", "Phone", "TenantType", "VatNumber", "Country", "CustomerId", "CreatedAt", "IsSoftDeleted")
VALUES ('tenant_01JGQ1GQ8G9NRQH3X7WVFV2K3Y', 'Test Tenant', 'Test Description', true, true, 'tenant@example.com', '123-456-7890', 1, 'VAT123', 'USA', 'customer_01JGQ1GQ8G9NRQH3X7WVFV2K3X', NOW(), false);
