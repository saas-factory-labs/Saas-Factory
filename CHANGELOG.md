...
* Disable package generation during Docker publish in Dockerfile ([e3aa833](https://github.com/saas-factory-labs/Saas-Factory/commit/e3aa833d0a19415492f0bfc64b64257048b2fffb))
...
* Add debug input to deployment workflow and update Railway CLI installation ([fa10cd6](https://github.com/saas-factory-labs/Saas-Factory/commit/fa10cd6935b344e07ae060f07018dff1d14d1ab7))
...
* **middleware:** add Cloudflare IP filter middleware to restrict incoming requests ([ec2958a](https://github.com/saas-factory-labs/Saas-Factory/commit/ec2958a4f307ecaa7850ba767401d985f6d21c8e))

## [1.11.2](https://github.com/saas-factory-labs/Saas-Factory/compare/v1.11.1...v1.11.2) (2026-03-31)


### Bug Fixes

* **auth:** strip x-client-SKU and x-client-ver fingerprint from OIDC authorization requests ([ba88153](https://github.com/saas-factory-labs/Saas-Factory/commit/ba88153f7c6909c72cbc8fce7d06d1325cd81cf2))

## [1.11.1](https://github.com/saas-factory-labs/Saas-Factory/compare/v1.11.0...v1.11.1) (2026-03-31)


### Bug Fixes

* **auth:** harden OAuth flow against CSRF, code leakage, and open-redirect risks ([e37b205](https://github.com/saas-factory-labs/Saas-Factory/commit/e37b20563a20fd17debba0393676a128ef7fd9be))
...
* **welcome-banner:** guard against empty string claims for display name ([497bf84](https://github.com/saas-factory-labs/Saas-Factory/commit/497bf84fdfdd145a3ec86f618e9e0e4f3ab6bd14))

## [1.9.2](https://github.com/saas-factory-labs/Saas-Factory/compare/v1.9.1...v1.9.2) (2026-03-30)
...
* **dashboard:** replace hardcoded "Acme Inc." greeting with logged-in user's name ([22ba895](https://github.com/saas-factory-labs/Saas-Factory/commit/22ba895b5438d8474210b97f5e033013c4162db7))

# [1.8.0](https://github.com/saas-factory-labs/Saas-Factory/compare/v1.7.2...v1.8.0) (2026-03-30)


### Features

* **onboarding:** add sign out button to /onboarding page ([3fba73b](https://github.com/saas-factory-labs/Saas-Factory/commit/3fba73b6d623cdf0f615259097874d2c12216b3a))
...
* **config:** correct API_BASE_URL env var for docker and railway deployments ([2a06183](https://github.com/saas-factory-labs/Saas-Factory/commit/2a061830312709a2e52f6752808b90b601352cd5))

# [1.7.0](https://github.com/saas-factory-labs/Saas-Factory/compare/v1.6.8...v1.7.0) (2026-03-29)


### Features

* **search:** expose search endpoint in API service and replace direct DB search in Web with HTTP calls via Kiota client ([307aebf](https://github.com/saas-factory-labs/Saas-Factory/commit/307aebf259ac907ee2e84e529c778bc0bc3a91a8))
...
* show onboarding loading state during prerender to prevent lost button clicks ([8d96b64](https://github.com/saas-factory-labs/Saas-Factory/commit/8d96b64700c92230408248804a2df2d69e17ad12))

## [1.6.3](https://github.com/saas-factory-labs/Saas-Factory/compare/v1.6.2...v1.6.3) (2026-03-29)


### Bug Fixes

* **onboarding:** fix invisible Create Account button and checkbox checked state on both account setup forms ([6b727f3](https://github.com/saas-factory-labs/Saas-Factory/commit/6b727f39e45b5e4dd757352b0a388f857d5d7a92))

## [1.6.2](https://github.com/saas-factory-labs/Saas-Factory/compare/v1.6.1...v1.6.2) (2026-03-29)


### Bug Fixes

* **onboarding:** fix invisible icon/title and cut-off buttons on account setup forms ([853989a](https://github.com/saas-factory-labs/Saas-Factory/commit/853989a5ced02433aae9249f0aec8360f29dd7c4))

## [1.6.1](https://github.com/saas-factory-labs/Saas-Factory/compare/v1.6.0...v1.6.1) (2026-03-29)


### Bug Fixes

* redirect unauthenticated-tenant users to /onboarding instead of /dashboard ([0b98c63](https://github.com/saas-factory-labs/Saas-Factory/commit/0b98c6322389f70ffeadbff94fe4d14806588f61))
...
* add Dockerfile.railway with repo-root-relative COPY paths for Railway CI ([47b2b92](https://github.com/saas-factory-labs/Saas-Factory/commit/47b2b9232e001b30102ad4b5e6818656bf9f61e8))

## [1.5.5](https://github.com/saas-factory-labs/Saas-Factory/compare/v1.5.4...v1.5.5) (2026-03-29)


### Bug Fixes

* remove SeedTest from production API, fix ApplyMigrations endpoint ([51f449c](https://github.com/saas-factory-labs/Saas-Factory/commit/51f449cb7503baafc0fb233a8177c684e057b115))
...
* correct Logto OIDC discovery URL in web authentication ([627fa05](https://github.com/saas-factory-labs/Saas-Factory/commit/627fa05f5a5d193f95378c8c6d97662015bfcc16))

## [1.5.1](https://github.com/saas-factory-labs/Saas-Factory/compare/v1.5.0...v1.5.1) (2026-03-29)


### Bug Fixes

* **auth:** prevent raw exception details from being sent to users ([83cb10b](https://github.com/saas-factory-labs/Saas-Factory/commit/83cb10b36e1a3f1520f4dd607ddc802e44855f9d))

# [1.5.0](https://github.com/saas-factory-labs/Saas-Factory/compare/v1.4.0...v1.5.0) (2026-03-16)


### Features

* add UseAppBlueprintAsync<TDbContext> startup extension ([93f15c7](https://github.com/saas-factory-labs/Saas-Factory/commit/93f15c7ee32329a0808d081652eddcba49179230))
